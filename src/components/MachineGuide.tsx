  ...
  return (
    ...
    >
      <div className="relative aspect-[1.2/1] min-h-72">
        ...
        <div
          className={cx(
            'machine-motion absolute inset-0',
            `machine-motion--${machine.guide.motion}`,
            !playing && 'machine-motion--paused',
          )}
          aria-hidden="true"
        >
          <img
            src={machine.photoUrl}
            alt=""
            className="h-full w-full object-contain p-3 opacity-35 mix-blend-screen [filter:sepia(1)_saturate(4)_hue-rotate(145deg)_brightness(1.25)]"
          />
        </div>
